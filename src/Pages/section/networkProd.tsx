...
import NetworkServer from  "../../assets/img/NetworkServer.jpg";

export const NetworkProd = () => {
  return (
      ...
      <div className="flex gap-3">
        <div className="">
          <p className="text-white mb-4">
            <span className="font-bold text-1xl mr-4">100%</span>
    ...
    <div>
      <div data-aos="fade-left">
        <img className="h-[50rem]" src={NetworkServer} alt="image hold" />
      </div>
    </div>
  </div>
  )
