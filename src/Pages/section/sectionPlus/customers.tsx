  ...
  return (
	...
	<div className="container px-6 py-12 mx-auto">
		<div className="grid items-center gap-4 xl:grid-cols-5">
			<div className="max-w-2xl mx-auto my-4  space-y-4 text-center xl:col-span-2 xl:text-left " data-aos="fade-up">
				<h2 className="text-4xl font-bold">Our Customer's Testimonies</h2>
				
			</div>
			<div className="p-6 xl:col-span-3">
				<div className="grid gap-4 md:grid-cols-2">
					<div className="grid content-center gap-4">
						<div className="p-6 rounded shadow-md dark:bg-gray-900" data-aos="fade-left">
						...
						<div className="p-6 rounded shadow-md dark:bg-gray-900" data-aos="fade-right">
					...
					<div className="grid content-center gap-4" data-aos="fade-right">
