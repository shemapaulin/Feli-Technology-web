...
import styles from './partener.module.scss';
...
const Parteners = () => {
  ...
  return (
	...
	<div className="container p-6 mx-auto space-y-6 text-center lg:p-8 lg:space-y-8" data-aos="fade-left">
	...
	<div className={styles.dataSection}>
        <form ref={form} onSubmit={sendEmail} className={styles.form}>
          <div className={styles.input} data-aos="fade-right">
            ...
            <input type="text" name="user_name" placeholder="Name" autoComplete="name" required data-aos="zoom-in-right"/>
          </div>
          <div className={styles.input} data-aos="fade-left">
            <label htmlFor="">Phone:</label>
            <input type="tel" name="user_phone" placeholder="Phone Number" autoComplete="tel" required data-aos="zoom-in-left"/>
          </div>
          <div className={styles.input} data-aos="fade-right">
            <label htmlFor="">Email:</label>
            <input type="email" name="user_email" placeholder="Email" autoComplete="" required data-aos="zoom-in-right"/>
          </div>
          <div className={styles.input} data-aos="fade-left">
            <label htmlFor="">Country / City:</label>
            <input type="text" name="user_address" placeholder="Country  -  City" autoComplete="street-address" required data-aos="zoom-in-left"/>
          </div>
          <div className={styles.input} data-aos="fade-left">
            <label htmlFor="">Little info about your company:</label>
            <textarea
              name="message" 
